...
% Last Modified by GUIDE v2.5 22-Oct-2014 19:35:44
...
if isequal(archivo,0)%si el usuario no eleige ningun archivo
 return 
    ...
    set(handles.btnabir,'Enable','off');
...
global a;
[archivo ruta]=uiputfile({'*.gif';'*.jpg'},'guardar imagen');
if isequal(archivo,0)%si el usuario no eleige ningun archivo
 return 
else
    ...
    imwrite(a,strcat(ruta,archivo),'quality',10);
     msgbox('Se guardó con exito','mensaje');
