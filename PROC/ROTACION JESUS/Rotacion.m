...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
value2 = get(handles.edit2, 'String');
value3 = get(handles.edit3, 'String');
...
value3 = get(handles.edit5, 'String');
...
if isequal(archivo,0)%si el usuario no eleige ningun archivo
 return 
    ...
    set(handles.angulomenu,'Enable','on');
    set(handles.movermenu,'Enable','on');
    set(handles.dimensionesmenu,'Enable','on');
